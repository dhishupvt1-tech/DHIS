...
// import { createQueuedAttendanceRecord } from '@/lib/db/Attendance';
// import type { QueuedAttendance } from '@/lib/db/Attendance';
import { type Student, addStudent, getAllStudents, getStudentBySchoolId, getStudentFullName, isValidSchoolId, updateStudent, updateStudentBySchoolId } from '@/lib/db/Student';
// import useQueuedAttendanceStore from '@/store/useQueuedAttendanceStore';
import { failSound, networkErrorSound, offlineSound, successSound } from '@/lib/utils/sound';
import { type Html5QrcodeResult, Html5QrcodeScanner, Html5QrcodeScannerState } from 'html5-qrcode';
import { useEffect, useRef, useState } from 'react';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { fulfillWithTimeLimit, throwErrorAfterTimeout } from '@/lib/utils/utils';
import { useQuery } from '@tanstack/react-query';
import { set } from 'zod';
import { Attendance, createOrUpdateAttendanceRecord } from '@/lib/db/Attendance';
